...
HD_PWD='/nfs/nfs2/home/barnecle/E315-Digital-Design/P2_EMA/vivado_project/vivado_project.runs/design_fpga_axi_dma_1_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_fpga_axi_dma_1_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_fpga_axi_dma_1_0.tcl
